...
ban = []
cr = '*L4LISA-BOT*'
vz = '*Terima Kasih Sudah Daftar Di L4LISA-BOT*'
const vcard = 'BEGIN:VCARD\n' //
            + 'VERSION:3.0\n' //
            + 'FN:L4LISA\n' //
            + 'ORG:Owner L4LISA;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=6283852033463:+6283852033463 \n' //
            + 'END:VCARD'
prefix = '!'
blocked = []
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 DAFTAR 」──\nMaaf sepertinya kamu belum terdaftar di L4LISA-BOT\nDaftar untuk menikmati fitur bot ini!\n\n!daftar Lisa|19\n\n──「 L4LISA-BOT 」──`,
			...
			const ownerNumber = ["6283852033463@s.whatsapp.net"]
			const mod = [ownerNumber,"6283852033463@s.whatsapp.net"]
			const adminbotnumber = ["6283852033463@s.whatsapp.net"]
			const frendsowner = ["6283852033463@s.whatsapp.net"]
			const premium = ["6283852033463@s.whatsapp.net"]
			...
			switch(command) {
				...
				if (!isUser) return reply(mess.only.userB)
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT L4LISA✨* 」\n*│+wa.me/6283852033463*╰──────*「 *L4LISA* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  L4LISA-BOT_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/6283852033463*╰──────*「 *L4LISA* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  L4LISA-BOT_*\n*_Ketik !daftarvip*' })
					break
					case 'cekmod': 
